...
public class AdapterMeals extends RecyclerView.Adapter<AdapterMeals.MyViewHolder> {

    List<ModelMeals> mealsList;
    Context context;

    public AdapterMeals(List<ModelMeals> mealsList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_meals_new, parent, false);
